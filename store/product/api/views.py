...
def list_products(request):
    ...
    # I didn't understand what do you mean by filter by user if you meant that only retrive the products created by the authenticated user
...
def create_product(request):
    ...
    return Response(data=ser_product.errors, status=status.HTTP_400_BAD_REQUEST)
